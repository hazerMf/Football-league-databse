-- return match result and referee name of a specific match
select away.club_name as 'Away club', away_club_goal as 'Away goal' , home_club_goal as 'Home goal', home.club_name as 'Home club',
